            ...
            <div class="col-lg-6 col-7">
              <nav aria-label="breadcrumb" class="d-none d-lg-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">List Delete Board</li>
                </ol>
              </nav>
            </div>
          </div>
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">List Delete Boards</h3>
            </div>
...
?>
                  <tr>
                    ...
                    <form role="form" method="post" action="del-board.php?id=<?php echo $data["id"]; ?>">
                    <td>
                    ...
                    <td class="table-actions">
                      <button type="submit" class="btn btn-outline-danger btn-sm" name="submit" id="update" value="" onclick="return confirm('คุณต้องการลบข้อมูลหรือไม่')">ลบ</button>                              
                    </td></form>
                  </tr>
<?php
    }
